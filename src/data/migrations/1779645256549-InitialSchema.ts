...
export class InitialSchema1779645256549 implements MigrationInterface {
  name = 'InitialSchema1779645256549';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "employee" ("id" uniqueidentifier NOT NULL CONSTRAINT "DF_3c2bc72f03fd5abbbc5ac169498" DEFAULT NEWSEQUENTIALID(), "firstName" nvarchar(255) NOT NULL, "lastName" nvarchar(255) NOT NULL, "email" nvarchar(255) NOT NULL, "hireDate" date NOT NULL, "salary" decimal(10,2) NOT NULL, "departmentId" uniqueidentifier NOT NULL, CONSTRAINT "UQ_817d1d427138772d47eca048855" UNIQUE ("email"), CONSTRAINT "PK_3c2bc72f03fd5abbbc5ac169498" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
